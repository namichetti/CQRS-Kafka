...
import com.technobank.account.command.api.command.WithDrawFundsCommand;
...
public class WithdrawFundsController {
    ...
    public ResponseEntity<BaseResponse> withdrawFunds(@PathVariable String id,
        ...
        try{
            ...
            return new ResponseEntity<>(new BaseResponse("El retiro de fondos en cuenta bancaria " +
            ...
            var safeError = "Error al procesar el request para retirar fondos a una cuenta bancaria para el id " + id;
